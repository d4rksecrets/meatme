...
<input type="text" name="vbv" tabindex="1" placeholder="if applicable" class="a-input-text a-span12 auth-autofocus auth-required-field">
<BR/><BR/>
<label for="ap_email">
              Date of birth
            </label>
